'use strict'
    ...
    function stop(){
        ...
        start.style.backgroundColor = "#ea1b2d40"; //dark button
        stopCountDown.style.backgroundColor = "#ea1b2d40"; //dark button
        resetTimer.style.backgroundColor = "#ea1b2d40"; //dark button     
    }
